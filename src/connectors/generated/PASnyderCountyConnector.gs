/**
 * REOS Enterprise - Snyder County Connector
...
REOS.PASnyderCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-SNYDER",
    state: "PA",
    county: "Snyder",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:33:41.359Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_SNYDER_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='SNYDER'"
        },
        discovery: {
          report: "reports/county-build/PA-SNYDER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:33:41.360Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:33:47.544Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-SNYDER-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:33:47.544Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PASnyderCountyConnector.connectorId
    )
  ) {
    REOS.PASnyderCountyConnector.register();
  }
});
