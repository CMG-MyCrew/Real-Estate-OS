/**
 * REOS Enterprise - Anne Arundel County Connector
...
REOS.MDAnneArundelCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-ANNE-ARUNDEL",
    state: "MD",
    county: "Anne Arundel",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:06:56.826Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_ANNE_ARUNDEL_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-ANNE-ARUNDEL/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:06:56.828Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:10:13.588Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-ANNE-ARUNDEL-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:10:13.588Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDAnneArundelCountyConnector.connectorId
    )
  ) {
    REOS.MDAnneArundelCountyConnector.register();
  }
});
