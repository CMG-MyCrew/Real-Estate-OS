/**
 * REOS Enterprise - Franklin County Connector
...
REOS.PAFranklinCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-FRANKLIN",
    state: "PA",
    county: "Franklin",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:26:39.295Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_FRANKLIN_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Franklin'"
        },
        discovery: {
          report: "reports/county-build/PA-FRANKLIN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:26:39.299Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:26:45.280Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-FRANKLIN-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:26:45.280Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAFranklinCountyConnector.connectorId
    )
  ) {
    REOS.PAFranklinCountyConnector.register();
  }
});
