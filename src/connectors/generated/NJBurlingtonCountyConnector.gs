/**
 * REOS Enterprise - Burlington County Connector
...
REOS.NJBurlingtonCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-BURLINGTON",
    state: "NJ",
    county: "Burlington",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:14:36.437Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_BURLINGTON_PROPERTY_ASSESSMENT_URL",
        ...
        sourceQuery: {
          where: "COUNTY='BURLINGTON'"
        },
        discovery: {
          report: "reports/county-build/NJ-BURLINGTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:14:36.439Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:14:37.927Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-BURLINGTON-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:14:37.927Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJBurlingtonCountyConnector.connectorId
    )
  ) {
    REOS.NJBurlingtonCountyConnector.register();
  }
});
