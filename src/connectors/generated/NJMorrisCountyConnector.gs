/**
 * REOS Enterprise - Morris County Connector
...
REOS.NJMorrisCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-MORRIS",
    state: "NJ",
    county: "Morris",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:18:41.284Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_MORRIS_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-MORRIS/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:18:41.285Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:18:42.939Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-MORRIS-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:18:42.939Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJMorrisCountyConnector.connectorId
    )
  ) {
    REOS.NJMorrisCountyConnector.register();
  }
});
