/**
 * REOS Enterprise - Calvert County Connector
...
REOS.MDCalvertCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-CALVERT",
    state: "MD",
    county: "Calvert",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:53:30.113Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_CALVERT_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-CALVERT/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:53:30.118Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:53:32.228Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-CALVERT-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:53:32.228Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDCalvertCountyConnector.connectorId
    )
  ) {
    REOS.MDCalvertCountyConnector.register();
  }
});
