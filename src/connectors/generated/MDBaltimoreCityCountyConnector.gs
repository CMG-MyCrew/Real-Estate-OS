/**
 * REOS Enterprise - Baltimore City County Connector
...
REOS.MDBaltimoreCityCountyConnector = (function () {
  var MANIFEST = {
    ...
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:07:17.576Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_BALTIMORE_CITY_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-BALTIMORE-CITY/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:07:17.578Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:10:15.103Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-BALTIMORE-CITY-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:10:15.103Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDBaltimoreCityCountyConnector.connectorId
    )
  ) {
    REOS.MDBaltimoreCityCountyConnector.register();
  }
});
