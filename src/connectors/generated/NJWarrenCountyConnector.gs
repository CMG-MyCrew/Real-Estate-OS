/**
 * REOS Enterprise - Warren County Connector
...
REOS.NJWarrenCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-WARREN",
    state: "NJ",
    county: "Warren",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:21:13.558Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_WARREN_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-WARREN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:21:13.581Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:21:14.350Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-WARREN-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:21:14.350Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJWarrenCountyConnector.connectorId
    )
  ) {
    REOS.NJWarrenCountyConnector.register();
  }
});
