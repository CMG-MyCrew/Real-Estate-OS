/**
 * REOS Enterprise - Monmouth County Connector
...
REOS.NJMonmouthCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-MONMOUTH",
    state: "NJ",
    county: "Monmouth",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:18:21.179Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_MONMOUTH_PROPERTY_ASSESSMENT_URL",
        ...
        sourceQuery: {
          where: "COUNTY='MONMOUTH'"
        },
        discovery: {
          report: "reports/county-build/NJ-MONMOUTH/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:18:21.180Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:18:21.999Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-MONMOUTH-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:18:21.999Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJMonmouthCountyConnector.connectorId
    )
  ) {
    REOS.NJMonmouthCountyConnector.register();
  }
});
