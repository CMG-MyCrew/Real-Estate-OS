/**
 * REOS Enterprise - Mercer County Connector
...
REOS.NJMercerCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-MERCER",
    state: "NJ",
    county: "Mercer",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:17:21.276Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_MERCER_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-MERCER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:17:21.277Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:17:22.871Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-MERCER-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:17:22.872Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJMercerCountyConnector.connectorId
    )
  ) {
    REOS.NJMercerCountyConnector.register();
  }
});
