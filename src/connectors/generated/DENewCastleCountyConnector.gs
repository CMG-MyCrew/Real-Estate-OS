/**
 * REOS Enterprise - New Castle County Connector
...
REOS.DENewCastleCountyConnector = (function () {
  var MANIFEST = {
    id: "DE-NEW-CASTLE",
    state: "DE",
    county: "New Castle",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T09:57:46.030Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_DE_NEW_CASTLE_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/DE-NEW-CASTLE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T09:57:46.031Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T09:57:47.517Z",
          sampleCount: 50,
          report: "reports/county-mapping/DE-NEW-CASTLE-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            parcelId: {
              score: 145,
    ...
    updatedAt: "2026-08-04T09:57:47.517Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.DENewCastleCountyConnector.connectorId
    )
  ) {
    REOS.DENewCastleCountyConnector.register();
  }
});
