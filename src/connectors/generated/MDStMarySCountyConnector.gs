/**
 * REOS Enterprise - St. Mary's County Connector
...
REOS.MDStMarySCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-ST-MARY-S",
    state: "MD",
    county: "St. Mary's",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:02:01.881Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_ST_MARY_S_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-ST-MARY-S/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:02:01.883Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:02:02.906Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-ST-MARY-S-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:02:02.906Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDStMarySCountyConnector.connectorId
    )
  ) {
    REOS.MDStMarySCountyConnector.register();
  }
});
