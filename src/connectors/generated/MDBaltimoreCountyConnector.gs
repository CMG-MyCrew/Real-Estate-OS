/**
 * REOS Enterprise - Baltimore County Connector
...
REOS.MDBaltimoreCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-BALTIMORE",
    state: "MD",
    county: "Baltimore",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:52:02.555Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_BALTIMORE_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-BALTIMORE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:52:02.561Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:52:06.158Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-BALTIMORE-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:52:06.159Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDBaltimoreCountyConnector.connectorId
    )
  ) {
    REOS.MDBaltimoreCountyConnector.register();
  }
});
