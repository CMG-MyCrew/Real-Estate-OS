/**
 * REOS Enterprise - York County Connector
...
REOS.PAYorkCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-YORK",
    state: "PA",
    county: "York",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:38:00.114Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_YORK_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='York'"
        },
        discovery: {
          report: "reports/county-build/PA-YORK/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:38:00.115Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:38:05.929Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-YORK-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:38:05.929Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAYorkCountyConnector.connectorId
    )
  ) {
    REOS.PAYorkCountyConnector.register();
  }
});
