/**
 * REOS Enterprise - Wyoming County Connector
...
REOS.PAWyomingCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-WYOMING",
    state: "PA",
    county: "Wyoming",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:37:27.348Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_WYOMING_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Wyoming'"
        },
        discovery: {
          report: "reports/county-build/PA-WYOMING/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:37:27.349Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:37:40.029Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-WYOMING-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:37:40.029Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAWyomingCountyConnector.connectorId
    )
  ) {
    REOS.PAWyomingCountyConnector.register();
  }
});
