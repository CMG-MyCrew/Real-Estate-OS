/**
 * REOS Enterprise - Sussex County Connector
...
REOS.DESussexCountyConnector = (function () {
  var MANIFEST = {
    id: "DE-SUSSEX",
    state: "DE",
    county: "Sussex",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T09:58:19.604Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_DE_SUSSEX_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/DE-SUSSEX/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T09:58:19.607Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T09:58:21.051Z",
          sampleCount: 50,
          report: "reports/county-mapping/DE-SUSSEX-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            parcelId: {
              score: 145,
    ...
    updatedAt: "2026-08-04T09:58:21.051Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.DESussexCountyConnector.connectorId
    )
  ) {
    REOS.DESussexCountyConnector.register();
  }
});
