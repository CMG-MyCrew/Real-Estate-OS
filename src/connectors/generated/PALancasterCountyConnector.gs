/**
 * REOS Enterprise - Lancaster County Connector
...
REOS.PALancasterCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-LANCASTER",
    state: "PA",
    county: "Lancaster",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:29:05.884Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_LANCASTER_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='LANCASTER'"
        },
        discovery: {
          report: "reports/county-build/PA-LANCASTER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:29:05.885Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:29:13.107Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-LANCASTER-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:29:13.108Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PALancasterCountyConnector.connectorId
    )
  ) {
    REOS.PALancasterCountyConnector.register();
  }
});
