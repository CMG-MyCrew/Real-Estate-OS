/**
 * REOS Enterprise - Cape May County Connector
...
REOS.NJCapeMayCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-CAPE-MAY",
    state: "NJ",
    county: "Cape May",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:15:18.414Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_CAPE_MAY_PROPERTY_ASSESSMENT_URL",
        ...
        sourceQuery: {
          where: "COUNTY='CAPE MAY'"
        },
        discovery: {
          report: "reports/county-build/NJ-CAPE-MAY/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:15:18.415Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:15:20.273Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-CAPE-MAY-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:15:20.273Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJCapeMayCountyConnector.connectorId
    )
  ) {
    REOS.NJCapeMayCountyConnector.register();
  }
});
