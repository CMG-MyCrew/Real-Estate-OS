/**
 * REOS Enterprise - Hunterdon County Connector
...
REOS.NJHunterdonCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-HUNTERDON",
    state: "NJ",
    county: "Hunterdon",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:16:58.819Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_HUNTERDON_PROPERTY_ASSESSMENT_URL",
        ...
        sourceQuery: {
          where: "COUNTY='HUNTERDON'"
        },
        discovery: {
          report: "reports/county-build/NJ-HUNTERDON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:16:58.821Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:17:00.731Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-HUNTERDON-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:17:00.731Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJHunterdonCountyConnector.connectorId
    )
  ) {
    REOS.NJHunterdonCountyConnector.register();
  }
});
