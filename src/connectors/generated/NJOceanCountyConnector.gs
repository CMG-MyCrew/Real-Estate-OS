/**
 * REOS Enterprise - Ocean County Connector
...
REOS.NJOceanCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-OCEAN",
    state: "NJ",
    county: "Ocean",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:19:03.940Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_OCEAN_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-OCEAN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:19:03.942Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:19:05.396Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-OCEAN-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:19:05.396Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJOceanCountyConnector.connectorId
    )
  ) {
    REOS.NJOceanCountyConnector.register();
  }
});
