...
REOS.PAUnionCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-UNION",
    state: "PA",
    county: "Union",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:35:36.679Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_UNION_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-UNION/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:35:36.680Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:35:42.842Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-UNION-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:35:42.842Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAUnionCountyConnector.connectorId
    )
  ) {
    REOS.PAUnionCountyConnector.register();
  }
});
