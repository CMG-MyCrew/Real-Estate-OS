/**
 * REOS Enterprise - Westmoreland County Connector
...
REOS.PAWestmorelandCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-WESTMORELAND",
    state: "PA",
    county: "Westmoreland",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:37:01.355Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_WESTMORELAND_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='WESTMORELAND'"
        },
        discovery: {
          report: "reports/county-build/PA-WESTMORELAND/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:37:01.356Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:37:06.856Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-WESTMORELAND-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:37:06.856Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAWestmorelandCountyConnector.connectorId
    )
  ) {
    REOS.PAWestmorelandCountyConnector.register();
  }
});
