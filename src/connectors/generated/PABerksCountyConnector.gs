/**
 * REOS Enterprise - Berks County Connector
...
REOS.PABerksCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-BERKS",
    state: "PA",
    county: "Berks",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:22:42.982Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_BERKS_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='BERKS'"
        },
        discovery: {
          report: "reports/county-build/PA-BERKS/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:22:42.985Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:22:48.354Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-BERKS-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:22:48.354Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PABerksCountyConnector.connectorId
    )
  ) {
    REOS.PABerksCountyConnector.register();
  }
});
