/**
 * REOS Enterprise - Northampton County Connector
...
REOS.PANorthamptonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-NORTHAMPTON",
    state: "PA",
    county: "Northampton",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:31:25.967Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_NORTHAMPTON_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='NORTHAMPTON'"
        },
        discovery: {
          report: "reports/county-build/PA-NORTHAMPTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:31:25.968Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:31:31.901Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-NORTHAMPTON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:31:31.901Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PANorthamptonCountyConnector.connectorId
    )
  ) {
    REOS.PANorthamptonCountyConnector.register();
  }
});
