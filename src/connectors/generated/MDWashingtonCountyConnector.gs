...
REOS.MDWashingtonCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-WASHINGTON",
    state: "MD",
    county: "Washington",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:03:29.578Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_WASHINGTON_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-WASHINGTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:03:29.581Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:03:31.171Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-WASHINGTON-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:03:31.171Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDWashingtonCountyConnector.connectorId
    )
  ) {
    REOS.MDWashingtonCountyConnector.register();
  }
});
