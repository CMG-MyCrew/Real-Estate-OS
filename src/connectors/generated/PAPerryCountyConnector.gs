/**
 * REOS Enterprise - Perry County Connector
...
REOS.PAPerryCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-PERRY",
    state: "PA",
    county: "Perry",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:32:22.362Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_PERRY_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Perry'"
        },
        discovery: {
          report: "reports/county-build/PA-PERRY/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:32:22.364Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:32:29.014Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-PERRY-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:32:29.014Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAPerryCountyConnector.connectorId
    )
  ) {
    REOS.PAPerryCountyConnector.register();
  }
});
