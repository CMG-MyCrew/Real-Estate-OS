/**
 * REOS Enterprise - Middlesex County Connector
...
REOS.NJMiddlesexCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-MIDDLESEX",
    state: "NJ",
    county: "Middlesex",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:18:01.296Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_MIDDLESEX_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-MIDDLESEX/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:18:01.298Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:18:02.790Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-MIDDLESEX-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:18:02.791Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJMiddlesexCountyConnector.connectorId
    )
  ) {
    REOS.NJMiddlesexCountyConnector.register();
  }
});
