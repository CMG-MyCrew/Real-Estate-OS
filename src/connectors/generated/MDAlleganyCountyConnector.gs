/**
 * REOS Enterprise - Allegany County Connector
...
REOS.MDAlleganyCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-ALLEGANY",
    state: "MD",
    county: "Allegany",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:51:16.696Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_ALLEGANY_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-ALLEGANY/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:51:16.701Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:51:18.837Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-ALLEGANY-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:51:18.837Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDAlleganyCountyConnector.connectorId
    )
  ) {
    REOS.MDAlleganyCountyConnector.register();
  }
});
