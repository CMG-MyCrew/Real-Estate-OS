/**
 * REOS Enterprise - Hudson County Connector
...
REOS.NJHudsonCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-HUDSON",
    state: "NJ",
    county: "Hudson",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:16:38.189Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_HUDSON_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-HUDSON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:16:38.190Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:16:39.162Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-HUDSON-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:16:39.163Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJHudsonCountyConnector.connectorId
    )
  ) {
    REOS.NJHudsonCountyConnector.register();
  }
});
