/**
 * REOS Enterprise - Fulton County Connector
...
REOS.PAFultonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-FULTON",
    state: "PA",
    county: "Fulton",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:27:11.079Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_FULTON_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-FULTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:27:11.080Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:27:17.870Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-FULTON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:27:17.870Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAFultonCountyConnector.connectorId
    )
  ) {
    REOS.PAFultonCountyConnector.register();
  }
});
