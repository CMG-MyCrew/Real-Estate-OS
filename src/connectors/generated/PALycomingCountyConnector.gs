/**
 * REOS Enterprise - Lycoming County Connector
...
REOS.PALycomingCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-LYCOMING",
    state: "PA",
    county: "Lycoming",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:30:28.377Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_LYCOMING_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Lycoming'"
        },
        discovery: {
          report: "reports/county-build/PA-LYCOMING/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:30:28.378Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:30:34.642Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-LYCOMING-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:30:34.642Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PALycomingCountyConnector.connectorId
    )
  ) {
    REOS.PALycomingCountyConnector.register();
  }
});
