/**
 * REOS Enterprise - Clinton County Connector
...
REOS.PAClintonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-CLINTON",
    state: "PA",
    county: "Clinton",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:24:56.331Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_CLINTON_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='CLINTON'"
        },
        discovery: {
          report: "reports/county-build/PA-CLINTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:24:56.333Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:25:03.886Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-CLINTON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:25:03.886Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAClintonCountyConnector.connectorId
    )
  ) {
    REOS.PAClintonCountyConnector.register();
  }
});
