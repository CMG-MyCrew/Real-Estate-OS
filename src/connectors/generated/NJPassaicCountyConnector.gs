/**
 * REOS Enterprise - Passaic County Connector
...
REOS.NJPassaicCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-PASSAIC",
    state: "NJ",
    county: "Passaic",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:19:23.620Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_PASSAIC_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-PASSAIC/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:19:23.622Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:19:25.004Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-PASSAIC-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:19:25.004Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJPassaicCountyConnector.connectorId
    )
  ) {
    REOS.NJPassaicCountyConnector.register();
  }
});
