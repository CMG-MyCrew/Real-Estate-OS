/**
 * REOS Enterprise - Lehigh County Connector
...
REOS.PALehighCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-LEHIGH",
    state: "PA",
    county: "Lehigh",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:30:02.352Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_LEHIGH_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-LEHIGH/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:30:02.353Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:30:08.195Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-LEHIGH-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:30:08.195Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PALehighCountyConnector.connectorId
    )
  ) {
    REOS.PALehighCountyConnector.register();
  }
});
