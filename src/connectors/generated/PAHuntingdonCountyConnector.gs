/**
 * REOS Enterprise - Huntingdon County Connector
...
REOS.PAHuntingdonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-HUNTINGDON",
    state: "PA",
    county: "Huntingdon",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:28:12.041Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_HUNTINGDON_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='HUNTINGDON'"
        },
        discovery: {
          report: "reports/county-build/PA-HUNTINGDON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:28:12.043Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:28:17.843Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-HUNTINGDON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:28:17.843Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAHuntingdonCountyConnector.connectorId
    )
  ) {
    REOS.PAHuntingdonCountyConnector.register();
  }
});
