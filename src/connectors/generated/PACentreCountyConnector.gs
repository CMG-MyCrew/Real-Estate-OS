/**
 * REOS Enterprise - Centre County Connector
...
REOS.PACentreCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-CENTRE",
    state: "PA",
    county: "Centre",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:24:07.094Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_CENTRE_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='CENTRE'"
        },
        discovery: {
          report: "reports/county-build/PA-CENTRE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:24:07.096Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:24:13.382Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-CENTRE-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:24:13.383Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PACentreCountyConnector.connectorId
    )
  ) {
    REOS.PACentreCountyConnector.register();
  }
});
