/**
 * REOS Enterprise - Blair County Connector
...
REOS.PABlairCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-BLAIR",
    state: "PA",
    county: "Blair",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:23:08.825Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_BLAIR_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-BLAIR/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:23:08.827Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:23:14.607Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-BLAIR-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:23:14.607Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PABlairCountyConnector.connectorId
    )
  ) {
    REOS.PABlairCountyConnector.register();
  }
});
