/**
 * REOS Enterprise - Clearfield County Connector
...
REOS.PAClearfieldCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-CLEARFIELD",
    state: "PA",
    county: "Clearfield",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:24:30.439Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_CLEARFIELD_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Clearfield'"
        },
        discovery: {
          report: "reports/county-build/PA-CLEARFIELD/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:24:30.441Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:24:35.283Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-CLEARFIELD-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:24:35.284Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAClearfieldCountyConnector.connectorId
    )
  ) {
    REOS.PAClearfieldCountyConnector.register();
  }
});
