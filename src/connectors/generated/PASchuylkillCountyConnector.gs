/**
 * REOS Enterprise - Schuylkill County Connector
...
REOS.PASchuylkillCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-SCHUYLKILL",
    state: "PA",
    county: "Schuylkill",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:33:15.221Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_SCHUYLKILL_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='SCHUYLKILL'"
        },
        discovery: {
          report: "reports/county-build/PA-SCHUYLKILL/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:33:15.222Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:33:21.124Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-SCHUYLKILL-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:33:21.125Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PASchuylkillCountyConnector.connectorId
    )
  ) {
    REOS.PASchuylkillCountyConnector.register();
  }
});
