/**
 * REOS Enterprise - Cecil County Connector
...
REOS.MDCecilCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-CECIL",
    state: "MD",
    county: "Cecil",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:55:26.423Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_CECIL_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-CECIL/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:55:26.425Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:55:28.076Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-CECIL-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:55:28.076Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDCecilCountyConnector.connectorId
    )
  ) {
    REOS.MDCecilCountyConnector.register();
  }
});
