/**
 * REOS Enterprise - Queen Anne's County Connector
...
REOS.MDQueenAnneSCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-QUEEN-ANNE-S",
    state: "MD",
    county: "Queen Anne's",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:00:58.255Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_QUEEN_ANNE_S_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-QUEEN-ANNE-S/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:00:58.263Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:00:59.345Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-QUEEN-ANNE-S-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:00:59.346Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDQueenAnneSCountyConnector.connectorId
    )
  ) {
    REOS.MDQueenAnneSCountyConnector.register();
  }
});
