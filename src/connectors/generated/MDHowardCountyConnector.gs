/**
 * REOS Enterprise - Howard County Connector
...
REOS.MDHowardCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-HOWARD",
    state: "MD",
    county: "Howard",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:58:50.073Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_HOWARD_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-HOWARD/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:58:50.074Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:58:52.100Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-HOWARD-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:58:52.100Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDHowardCountyConnector.connectorId
    )
  ) {
    REOS.MDHowardCountyConnector.register();
  }
});
