/**
 * REOS Enterprise - Potter County Connector
...
REOS.PAPotterCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-POTTER",
    state: "PA",
    county: "Potter",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:32:50.226Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_POTTER_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='POTTER'"
        },
        discovery: {
          report: "reports/county-build/PA-POTTER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:32:50.227Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:32:55.737Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-POTTER-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:32:55.737Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAPotterCountyConnector.connectorId
    )
  ) {
    REOS.PAPotterCountyConnector.register();
  }
});
