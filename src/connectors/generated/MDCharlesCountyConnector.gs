/**
 * REOS Enterprise - Charles County Connector
...
REOS.MDCharlesCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-CHARLES",
    state: "MD",
    county: "Charles",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:56:01.273Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_CHARLES_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-CHARLES/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:56:01.276Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:56:02.862Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-CHARLES-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:56:02.862Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDCharlesCountyConnector.connectorId
    )
  ) {
    REOS.MDCharlesCountyConnector.register();
  }
});
