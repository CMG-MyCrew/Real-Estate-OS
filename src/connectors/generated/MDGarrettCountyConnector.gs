/**
 * REOS Enterprise - Garrett County Connector
...
REOS.MDGarrettCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-GARRETT",
    state: "MD",
    county: "Garrett",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:57:51.734Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_GARRETT_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-GARRETT/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:57:51.736Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:57:53.106Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-GARRETT-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:57:53.106Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDGarrettCountyConnector.connectorId
    )
  ) {
    REOS.MDGarrettCountyConnector.register();
  }
});
