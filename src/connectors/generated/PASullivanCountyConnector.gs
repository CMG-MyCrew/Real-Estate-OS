/**
 * REOS Enterprise - Sullivan County Connector
...
REOS.PASullivanCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-SULLIVAN",
    state: "PA",
    county: "Sullivan",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:34:38.327Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_SULLIVAN_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Sullivan'"
        },
        discovery: {
          report: "reports/county-build/PA-SULLIVAN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:34:38.328Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:34:44.870Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-SULLIVAN-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:34:44.870Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PASullivanCountyConnector.connectorId
    )
  ) {
    REOS.PASullivanCountyConnector.register();
  }
});
