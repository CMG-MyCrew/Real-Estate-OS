/**
 * REOS Enterprise - Washington County Connector
...
REOS.PAWashingtonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-WASHINGTON",
    state: "PA",
    county: "Washington",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:36:03.922Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_WASHINGTON_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Washington'"
        },
        discovery: {
          report: "reports/county-build/PA-WASHINGTON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:36:03.923Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:36:10.065Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-WASHINGTON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:36:10.066Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAWashingtonCountyConnector.connectorId
    )
  ) {
    REOS.PAWashingtonCountyConnector.register();
  }
});
