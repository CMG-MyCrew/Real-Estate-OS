/**
 * REOS Enterprise - Caroline County Connector
...
REOS.MDCarolineCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-CAROLINE",
    state: "MD",
    county: "Caroline",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:54:13.995Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_CAROLINE_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-CAROLINE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:54:13.998Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:54:15.782Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-CAROLINE-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:54:15.783Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDCarolineCountyConnector.connectorId
    )
  ) {
    REOS.MDCarolineCountyConnector.register();
  }
});
