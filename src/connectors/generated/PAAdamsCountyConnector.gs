/**
 * REOS Enterprise - Adams County Connector
...
REOS.PAAdamsCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-ADAMS",
    state: "PA",
    county: "Adams",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T17:32:12.491Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_ADAMS_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-ADAMS/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T17:32:12.496Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T17:37:19.248Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-ADAMS-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T17:37:19.248Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAAdamsCountyConnector.connectorId
    )
  ) {
    REOS.PAAdamsCountyConnector.register();
  }
});
