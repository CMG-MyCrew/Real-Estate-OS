/**
 * REOS Enterprise - Bedford County Connector
...
REOS.PABedfordCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-BEDFORD",
    state: "PA",
    county: "Bedford",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:22:17.337Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_BEDFORD_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='BEDFORD'"
        },
        discovery: {
          report: "reports/county-build/PA-BEDFORD/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:22:17.339Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:22:22.922Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-BEDFORD-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:22:22.924Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PABedfordCountyConnector.connectorId
    )
  ) {
    REOS.PABedfordCountyConnector.register();
  }
});
