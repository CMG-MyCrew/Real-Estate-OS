/**
 * REOS Enterprise - Harford County Connector
...
REOS.MDHarfordCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-HARFORD",
    state: "MD",
    county: "Harford",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:58:21.889Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_HARFORD_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-HARFORD/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:58:21.890Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:58:23.387Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-HARFORD-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:58:23.387Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDHarfordCountyConnector.connectorId
    )
  ) {
    REOS.MDHarfordCountyConnector.register();
  }
});
