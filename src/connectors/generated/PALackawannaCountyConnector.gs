/**
 * REOS Enterprise - Lackawanna County Connector
...
REOS.PALackawannaCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-LACKAWANNA",
    state: "PA",
    county: "Lackawanna",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:28:39.262Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_LACKAWANNA_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Lackawanna'"
        },
        discovery: {
          report: "reports/county-build/PA-LACKAWANNA/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:28:39.264Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:28:45.506Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-LACKAWANNA-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:28:45.506Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PALackawannaCountyConnector.connectorId
    )
  ) {
    REOS.PALackawannaCountyConnector.register();
  }
});
