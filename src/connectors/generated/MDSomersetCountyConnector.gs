...
REOS.MDSomersetCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-SOMERSET",
    state: "MD",
    county: "Somerset",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:01:31.237Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_SOMERSET_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-SOMERSET/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:01:31.239Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:01:32.765Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-SOMERSET-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:01:32.765Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDSomersetCountyConnector.connectorId
    )
  ) {
    REOS.MDSomersetCountyConnector.register();
  }
});
