/**
 * REOS Enterprise - Camden County Connector
...
REOS.NJCamdenCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-CAMDEN",
    state: "NJ",
    county: "Camden",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:14:57.087Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_CAMDEN_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-CAMDEN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:14:57.088Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:14:58.204Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-CAMDEN-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:14:58.204Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJCamdenCountyConnector.connectorId
    )
  ) {
    REOS.NJCamdenCountyConnector.register();
  }
});
