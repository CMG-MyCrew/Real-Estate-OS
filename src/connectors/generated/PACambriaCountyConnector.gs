/**
 * REOS Enterprise - Cambria County Connector
...
REOS.PACambriaCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-CAMBRIA",
    state: "PA",
    county: "Cambria",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:23:32.475Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_CAMBRIA_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='CAMBRIA'"
        },
        discovery: {
          report: "reports/county-build/PA-CAMBRIA/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:23:32.476Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:23:45.350Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-CAMBRIA-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:23:45.350Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PACambriaCountyConnector.connectorId
    )
  ) {
    REOS.PACambriaCountyConnector.register();
  }
});
