/**
 * REOS Enterprise - Gloucester County Connector
...
REOS.NJGloucesterCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-GLOUCESTER",
    state: "NJ",
    county: "Gloucester",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:16:18.522Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_GLOUCESTER_PROPERTY_ASSESSMENT_URL",
        ...
        sourceQuery: {
          where: "COUNTY='GLOUCESTER'"
        },
        discovery: {
          report: "reports/county-build/NJ-GLOUCESTER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:16:18.525Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:16:20.013Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-GLOUCESTER-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:16:20.013Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJGloucesterCountyConnector.connectorId
    )
  ) {
    REOS.NJGloucesterCountyConnector.register();
  }
});
