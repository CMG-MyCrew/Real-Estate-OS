/**
 * REOS Enterprise - Carroll County Connector
...
REOS.MDCarrollCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-CARROLL",
    state: "MD",
    county: "Carroll",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:54:50.174Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_CARROLL_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-CARROLL/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:54:50.183Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:54:52.051Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-CARROLL-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:54:52.051Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDCarrollCountyConnector.connectorId
    )
  ) {
    REOS.MDCarrollCountyConnector.register();
  }
});
