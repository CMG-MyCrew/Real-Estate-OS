/**
 * REOS Enterprise - Worcester County Connector
...
REOS.MDWorcesterCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-WORCESTER",
    state: "MD",
    county: "Worcester",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:05:03.818Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_WORCESTER_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-WORCESTER/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:05:03.820Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:05:05.003Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-WORCESTER-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:05:05.003Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDWorcesterCountyConnector.connectorId
    )
  ) {
    REOS.MDWorcesterCountyConnector.register();
  }
});
