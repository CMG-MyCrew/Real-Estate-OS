/**
 * REOS Enterprise - Prince George's County Connector
...
REOS.MDPrinceGeorgeSCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-PRINCE-GEORGE-S",
    state: "MD",
    county: "Prince George's",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:00:26.145Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_PRINCE_GEORGE_S_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          ...
          candidate: 1,
          promotedAt: "2026-08-04T16:00:26.146Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:00:27.124Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-PRINCE-GEORGE-S-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:00:27.124Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDPrinceGeorgeSCountyConnector.connectorId
    )
  ) {
    REOS.MDPrinceGeorgeSCountyConnector.register();
  }
});
