...
REOS.NJSomersetCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-SOMERSET",
    state: "NJ",
    county: "Somerset",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:20:05.869Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_SOMERSET_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-SOMERSET/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:20:05.870Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:20:07.440Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-SOMERSET-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:20:07.440Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJSomersetCountyConnector.connectorId
    )
  ) {
    REOS.NJSomersetCountyConnector.register();
  }
});
