/**
 * REOS Enterprise - Union County Connector
...
REOS.NJUnionCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-UNION",
    state: "NJ",
    county: "Union",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:20:51.576Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_UNION_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-UNION/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:20:51.578Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:20:52.866Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-UNION-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:20:52.866Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJUnionCountyConnector.connectorId
    )
  ) {
    REOS.NJUnionCountyConnector.register();
  }
});
