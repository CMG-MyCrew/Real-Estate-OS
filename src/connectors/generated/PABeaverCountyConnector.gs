/**
 * REOS Enterprise - Beaver County Connector
...
REOS.PABeaverCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-BEAVER",
    state: "PA",
    county: "Beaver",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-05T01:03:53.486Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_BEAVER_PARCEL_INVENTORY_URL",
        enabled: true,
        maxLimit: 2000,
        mapping: {
          address: [
        ...
        endpoint: "https://gis.beavercountypa.gov/server/rest/services/InfoAtlas/Parcels_with_Owner/MapServer/22/query",
        sourceQuery: {
          where: "1=1"
        },
        discovery: {
          report: "reports/county-source-review/PA-BEAVER.json",
          title: "Beaver County Parcels with Owner",
          source: "Beaver County Geo Hub",
          sourceScope: "county",
          authoritative: true,
          endpoint: "https://gis.beavercountypa.gov/server/rest/services/InfoAtlas/Parcels_with_Owner/MapServer/22/query"
        },
        ...
        autoMapping: {
          appliedAt: "2026-08-05T01:06:16.212Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-BEAVER-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 109,
              primaryField: "Mail_Address",
              completeness: 0.84,
              alternatives: [
                "Location_Street"
              ]
            ...
            city: {
              score: 89,
              primaryField: "Mail_City",
              completeness: 0.84,
              alternatives: []
            },
            zip: {
              score: 109,
              primaryField: "Mail_Zipcode",
              completeness: 0.84,
              alternatives: []
            },
            parcelId: {
    ...
    updatedAt: "2026-08-05T01:06:16.212Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PABeaverCountyConnector.connectorId
    )
  ) {
    REOS.PABeaverCountyConnector.register();
  }
});
