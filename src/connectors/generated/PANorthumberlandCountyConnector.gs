/**
 * REOS Enterprise - Northumberland County Connector
...
REOS.PANorthumberlandCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-NORTHUMBERLAND",
    state: "PA",
    county: "Northumberland",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:31:52.003Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_NORTHUMBERLAND_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Northumberland'"
        },
        discovery: {
          report: "reports/county-build/PA-NORTHUMBERLAND/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:31:52.004Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:31:58.846Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-NORTHUMBERLAND-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:31:58.846Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PANorthumberlandCountyConnector.connectorId
    )
  ) {
    REOS.PANorthumberlandCountyConnector.register();
  }
});
