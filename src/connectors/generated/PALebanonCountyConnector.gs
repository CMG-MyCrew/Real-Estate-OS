/**
 * REOS Enterprise - Lebanon County Connector
...
REOS.PALebanonCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-LEBANON",
    state: "PA",
    county: "Lebanon",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:29:32.094Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_LEBANON_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='LEBANON'"
        },
        discovery: {
          report: "reports/county-build/PA-LEBANON/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:29:32.095Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:29:38.673Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-LEBANON-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:29:38.673Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PALebanonCountyConnector.connectorId
    )
  ) {
    REOS.PALebanonCountyConnector.register();
  }
});
