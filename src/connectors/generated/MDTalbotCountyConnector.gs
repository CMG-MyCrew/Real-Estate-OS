/**
 * REOS Enterprise - Talbot County Connector
...
REOS.MDTalbotCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-TALBOT",
    state: "MD",
    county: "Talbot",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:02:34.780Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_TALBOT_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-TALBOT/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:02:34.781Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:02:35.868Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-TALBOT-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:02:35.868Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDTalbotCountyConnector.connectorId
    )
  ) {
    REOS.MDTalbotCountyConnector.register();
  }
});
