/**
 * REOS Enterprise - Cumberland County Connector
...
REOS.NJCumberlandCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-CUMBERLAND",
    state: "NJ",
    county: "Cumberland",
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJCumberlandCountyConnector.connectorId
    )
  ) {
    REOS.NJCumberlandCountyConnector.register();
  }
});
