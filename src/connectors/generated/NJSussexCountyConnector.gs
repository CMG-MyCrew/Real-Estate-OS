...
REOS.NJSussexCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-SUSSEX",
    state: "NJ",
    county: "Sussex",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:20:26.168Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_SUSSEX_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-SUSSEX/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:20:26.171Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:20:28.034Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-SUSSEX-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:20:28.034Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJSussexCountyConnector.connectorId
    )
  ) {
    REOS.NJSussexCountyConnector.register();
  }
});
