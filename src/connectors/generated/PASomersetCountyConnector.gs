/**
 * REOS Enterprise - Somerset County Connector
...
REOS.PASomersetCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-SOMERSET",
    state: "PA",
    county: "Somerset",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:34:06.394Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_SOMERSET_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='SOMERSET'"
        },
        discovery: {
          report: "reports/county-build/PA-SOMERSET/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:34:06.395Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:34:13.785Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-SOMERSET-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:34:13.785Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PASomersetCountyConnector.connectorId
    )
  ) {
    REOS.PASomersetCountyConnector.register();
  }
});
