/**
 * REOS Enterprise - Mifflin County Connector
...
REOS.PAMifflinCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-MIFFLIN",
    state: "PA",
    county: "Mifflin",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:30:59.855Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_MIFFLIN_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='MIFFLIN'"
        },
        discovery: {
          report: "reports/county-build/PA-MIFFLIN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:30:59.857Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:31:04.832Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-MIFFLIN-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:31:04.832Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAMifflinCountyConnector.connectorId
    )
  ) {
    REOS.PAMifflinCountyConnector.register();
  }
});
