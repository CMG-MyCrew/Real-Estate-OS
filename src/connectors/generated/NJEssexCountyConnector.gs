/**
 * REOS Enterprise - Essex County Connector
...
REOS.NJEssexCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-ESSEX",
    state: "NJ",
    county: "Essex",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:16:00.046Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_ESSEX_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-ESSEX/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:16:00.048Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:16:00.811Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-ESSEX-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:16:00.812Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJEssexCountyConnector.connectorId
    )
  ) {
    REOS.NJEssexCountyConnector.register();
  }
});
