/**
 * REOS Enterprise - Frederick County Connector
...
REOS.MDFrederickCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-FREDERICK",
    state: "MD",
    county: "Frederick",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:57:21.335Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_FREDERICK_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-FREDERICK/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:57:21.336Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:57:22.785Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-FREDERICK-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:57:22.785Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDFrederickCountyConnector.connectorId
    )
  ) {
    REOS.MDFrederickCountyConnector.register();
  }
});
