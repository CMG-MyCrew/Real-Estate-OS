/**
 * REOS Enterprise - Wayne County Connector
...
REOS.PAWayneCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-WAYNE",
    state: "PA",
    county: "Wayne",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:36:31.948Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_WAYNE_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-WAYNE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:36:31.949Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:36:39.547Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-WAYNE-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:36:39.547Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAWayneCountyConnector.connectorId
    )
  ) {
    REOS.PAWayneCountyConnector.register();
  }
});
