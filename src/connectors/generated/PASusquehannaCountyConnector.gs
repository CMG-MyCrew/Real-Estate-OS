/**
 * REOS Enterprise - Susquehanna County Connector
...
REOS.PASusquehannaCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-SUSQUEHANNA",
    state: "PA",
    county: "Susquehanna",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:35:07.792Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_SUSQUEHANNA_PARCEL_INVENTORY_URL",
        ...
        sourceQuery: {
          where: "COUNTY_NAME='Susquehanna'"
        },
        discovery: {
          report: "reports/county-build/PA-SUSQUEHANNA/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:35:07.793Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:35:14.257Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-SUSQUEHANNA-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:35:14.257Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PASusquehannaCountyConnector.connectorId
    )
  ) {
    REOS.PASusquehannaCountyConnector.register();
  }
});
