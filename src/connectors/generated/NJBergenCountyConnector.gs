/**
 * REOS Enterprise - Bergen County Connector
...
REOS.NJBergenCountyConnector = (function () {
  var MANIFEST = {
    id: "NJ-BERGEN",
    state: "NJ",
    county: "Bergen",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T12:02:08.794Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_NJ_BERGEN_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/NJ-BERGEN/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T12:02:08.797Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T12:02:10.300Z",
          sampleCount: 50,
          report: "reports/county-mapping/NJ-BERGEN-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 165,
    ...
    updatedAt: "2026-08-04T12:02:10.300Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.NJBergenCountyConnector.connectorId
    )
  ) {
    REOS.NJBergenCountyConnector.register();
  }
});
