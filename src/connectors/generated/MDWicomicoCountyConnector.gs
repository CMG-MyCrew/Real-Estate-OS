/**
 * REOS Enterprise - Wicomico County Connector
...
REOS.MDWicomicoCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-WICOMICO",
    state: "MD",
    county: "Wicomico",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T16:04:19.907Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_WICOMICO_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-WICOMICO/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T16:04:19.910Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T16:04:21.496Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-WICOMICO-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T16:04:21.496Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDWicomicoCountyConnector.connectorId
    )
  ) {
    REOS.MDWicomicoCountyConnector.register();
  }
});
