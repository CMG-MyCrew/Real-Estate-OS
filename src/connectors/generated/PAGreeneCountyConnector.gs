/**
 * REOS Enterprise - Greene County Connector
...
REOS.PAGreeneCountyConnector = (function () {
  var MANIFEST = {
    id: "PA-GREENE",
    state: "PA",
    county: "Greene",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T18:27:37.867Z",
    datasets: {
      parcel_inventory: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_PA_GREENE_PARCEL_INVENTORY_URL",
        ...
        discovery: {
          report: "reports/county-build/PA-GREENE/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T18:27:37.868Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T18:27:43.946Z",
          sampleCount: 50,
          report: "reports/county-mapping/PA-GREENE-PARCEL_INVENTORY-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 115,
    ...
    updatedAt: "2026-08-04T18:27:43.947Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.PAGreeneCountyConnector.connectorId
    )
  ) {
    REOS.PAGreeneCountyConnector.register();
  }
});
