...
REOS.MDKentCountyConnector = (function () {
  var MANIFEST = {
    id: "MD-KENT",
    state: "MD",
    county: "Kent",
    version: "1.0.0",
    enabled: true,
    generatedAt: "2026-08-04T15:59:12.049Z",
    datasets: {
      property_assessment: {
        adapter: "arcgis",
        endpointProperty: "REOS_COUNTY_MD_KENT_PROPERTY_ASSESSMENT_URL",
        ...
        discovery: {
          report: "reports/county-build/MD-KENT/promotion-input.json",
          candidate: 1,
          promotedAt: "2026-08-04T15:59:12.052Z",
        ...
        autoMapping: {
          appliedAt: "2026-08-04T15:59:12.923Z",
          sampleCount: 50,
          report: "reports/county-mapping/MD-KENT-PROPERTY_ASSESSMENT-MAPPING.json",
          minimumScore: 65,
          confidence: {
            address: {
              score: 139,
    ...
    updatedAt: "2026-08-04T15:59:12.923Z"
  };
...
REOS.GeneratedCountyConnectorRegistrars.push(function () {
  if (
    !REOS.CountyConnectorSDK.get(
      REOS.MDKentCountyConnector.connectorId
    )
  ) {
    REOS.MDKentCountyConnector.register();
  }
});
