...
REOS.AcquisitionIntelligenceAutomation = (function () {
  var HANDLER = 'reosAcquisitionIntelligenceDailyRun';
  ...
  function run(options) {
    ...
    if (
      ...
      typeof REOS.AcquisitionIntelligence.analyzeAll !== 'function'
    ) {
      throw new Error(
    ...
    if (
      ...
      typeof REOS.AcquisitionOfferAutomation.generateDrafts ===
        'function'
    ) {
      offers =
  ...
  function status() {
    ...
    return {
      ...
      intelligence:
        REOS.AcquisitionIntelligence &&
        typeof REOS.AcquisitionIntelligence.summary ===
          'function'
          ? REOS.AcquisitionIntelligence.summary(10)
          : null,
      offers:
        REOS.AcquisitionOfferAutomation &&
        typeof REOS.AcquisitionOfferAutomation.summary ===
          'function'
